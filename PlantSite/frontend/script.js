...
function renderGridView(plants) {
    ...
    plants.forEach(plant => {
        ...
        const fallbackSrc = `s3://wesleyatwell.com.cdn/images2/${plant.name}/image1.png`;
        const img = document.createElement("img");
        img.src = `s3://wesleyatwell.com.cdn/images2/${plant.name}/image1.jpg` ; // Primary image or placeholder
